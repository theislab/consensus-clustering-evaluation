...
url        <- "https://seurat.nygenome.org/azimuth/demo_datasets/bmcite_demo.rds"
full_file  <- "azimuth-marrow_full.Rds"
sample     <- "batch2"
sample_col <- "donor"
labels_col <- "celltype.l2"
out_file   <- "azimuth-marrow_batch2.h5ad"
...
sce <- SingleCellExperiment(
    assays = list(counts = GetAssayData(seurat, slot = "counts", assay = "RNA")),
    colData = seurat[[]]
)
