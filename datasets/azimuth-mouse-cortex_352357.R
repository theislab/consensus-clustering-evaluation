...
url        <- "https://seurat.nygenome.org/azimuth/demo_datasets/allen_mop_2020.rds"
full_file  <- "azimuth-mouse-cortex_full.Rds"
sample     <- "352357"
sample_col <- "external_donor_name"
labels_col <- "subclass"
out_file   <- "azimuth-mouse-cortex_352357.h5ad"
