...
def run_homogeneity(adata, dataset, labels, method):

    print("Calculating Homogeneity...")
    score = homogeneity_score(adata.obs[labels], adata.obs["Cluster"])
...
if __name__=="__main__":
    ...
    print("Read data:")
    print(adata)
    results = run_homogeneity(adata, dataset, labels, method)
